...
func (s *Service) CORSHandler() http.HandlerFunc {
	return func(rw http.ResponseWriter, r *http.Request) {
		...
		rw.Header().Set("Access-Control-Allow-Headers", "Content-Type, Content-Length, Accept-Encoding, X-CSRF-Token, Authorization, accept, origin, Cache-Control, X-Requested-With, X-Filename header")
